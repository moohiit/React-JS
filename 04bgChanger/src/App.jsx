  ...
  return (
    <>
      ...
      style={{backgroundColor: color}}>
        <div className='fixed flex flex-wrap justify-center top-12 inset-x-0 gap-3 shadow-lg bg-gray-400 px-3 py-2 rounded-2xl'><p className='outline-none px-4 py-1 rounded-full text-black bg-white font-semibold text-3xl shadow-lg'>Color Changer App</p></div>
